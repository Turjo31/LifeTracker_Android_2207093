    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signInButton.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(name) || TextUtils.isEmpty(gender) || TextUtils.isEmpty(age) || TextUtils.isEmpty(email) || TextUtils.isEmpty(password)) {
                Toast.makeText(AdminSignInActivity.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                return;
            }
                            ...
                            if (user != null) {
                                ...
                                mDatabase.child("users").child(userId).setValue(userData)
                                        .addOnSuccessListener(aVoid -> {
                                            Toast.makeText(AdminSignInActivity.this, "Admin Sign In Successful", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(AdminSignInActivity.this, AdminDashboardActivity.class);
                                            startActivity(intent);
                                            finish();
                                        })
                                        .addOnFailureListener(e -> Toast.makeText(AdminSignInActivity.this, "Error saving user data.", Toast.LENGTH_SHORT).show());
                            }
                        } else {
